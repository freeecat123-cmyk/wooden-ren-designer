  ...
  return (
    <div ref={ref} className="relative">
      <button
        type="button"
        onClick={() => setOpen((s) => !s)}
        className="inline-flex items-center gap-2 rounded-lg bg-white px-3 py-1.5 max-md:min-h-[44px] text-sm font-medium text-zinc-800 ring-1 ring-zinc-200 shadow-sm hover:bg-amber-50 hover:ring-amber-300 transition"
      >
        {avatar ? (
