...
const TAB_IDS: TabId[] = ["structure", "style", "joinery", "scene"];
...
export function AdvancedSheet({
  ...
  const tSheet = useTranslations("mobile.advancedSheet");
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between px-4 py-2 border-b border-amber-900/10 min-h-[52px]">
        ...
        <h2 className="font-serif-tc text-base font-bold text-amber-950">{tSheet("title")}</h2>
        <div className="w-11" />
      </div>
