...
| 穿帶騎腳頂 / 抽屜橫向分格 / 腳墊選項 | `"穿帶\|batten\|drawerCols\|shoeAllowance"` | §AU25 |
...
**`shoeAllowanceMm` 正名**：他回報「腳墊加厚看不出來」。它本來就只影響「建議桌高」（833 → 863），
不畫任何東西，但舊標籤「鞋底／腳墊加厚」讓人以為會在圖上長出腳墊。
改成「站著時腳下墊多高（鞋底＋防疲勞墊）」，help 開頭直接寫「⚠️ 只用來算建議桌高，不會在圖上畫任何東西」。
⭐通則：**選項名要說「它會改什麼」，不是「它代表什麼」**。
