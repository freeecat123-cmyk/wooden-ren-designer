...
export const benchOptions: OptionSpec[] = [
  ...
  { group: "apron", type: "number", key: "apronWidth", label: "牙條高 (mm)", defaultValue: 60, min: 30, max: 200, step: 5, help: "長凳常見 50–70；80+ 配薄座板會頭輕腳重" },
  { group: "apron", type: "number", key: "apronOffset", label: "牙條距座板 (mm)", defaultValue: 0, min: 0, max: 400, step: 5 },
