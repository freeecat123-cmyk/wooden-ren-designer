...
export const CATEGORY_LABELS_EN: Record<FurnitureCategory, string> = {
  "cert-c1": "Trade test Class C — Q1",
  "cert-c2": "Trade test Class C — Q2",
  "cert-c3": "Trade test Class C — Q3",
  "cert-b1": "Trade test Class B — Q1",
  "cert-b2": "Trade test Class B — Q2",
  "cert-b3": "Trade test Class B — Q3",
  "cert-b4": "Trade test Class B — Q4",
  "cert-b5": "Trade test Class B — Q5",
  "cert-b6": "Trade test Class B — Q6",
  stool: "Square stool",
  bench: "Bench",
  "tea-table": "Tea table",
