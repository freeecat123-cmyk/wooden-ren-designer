...
export const sideTableOptions: OptionSpec[] = [
  ...
  { group: "apron", type: "number", key: "apronWidth", label: "牙條高 (mm)", defaultValue: 60, min: 30, max: 200, step: 5, dependsOn: { key: "withDrawer", equals: false } },
  ...
  { group: "apron", type: "number", key: "apronOffset", label: "牙條距桌面 (mm)", defaultValue: 0, min: 0, max: 200, step: 5, help: "邊桌總高約 600，5–10 比例適中", dependsOn: { key: "withDrawer", equals: false } },
