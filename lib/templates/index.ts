...
export const FURNITURE_CATALOG: FurnitureCatalogEntry[] = [
  ...
  },
  {
    ...
    description: "明清家具榫卯工法，邊抹板心做法，4 立柱 + 6 面框板",
    descriptionEn: "Ming/Qing-style cabinet with mortise-and-tenon joinery, frame-and-panel construction — 4 corner posts and 6 panel frames",
    difficulty: "advanced",
