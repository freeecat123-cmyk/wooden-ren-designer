...
export interface FurnitureCatalogEntry {
  ...
  nameZh: string;
  description: string;
  /** @deprecated 改用 joineryClass，留著相容 print page */
  difficulty: "beginner" | "intermediate" | "advanced";
  /**
   * 組裝難度按「主要榫接技法」分(2026-05-18 取代主觀 difficulty):
   * - screw    🟢 螺絲/木釘/平接,新手可
   * - tenon    🟡 半榫/通榫/牙條榫,木工常見
   * - advanced 🔴 鳩尾/sheared/角榫/曲面,進階木匠
   */
  joineryClass: "screw" | "tenon" | "advanced";
