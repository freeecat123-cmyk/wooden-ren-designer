...
export const diningTableOptions: OptionSpec[] = [
  ...
  { group: "leg", type: "number", key: "legSize", label: "桌腳粗", defaultValue: 70, min: 20, max: 120, step: 2 },
  { group: "leg", type: "number", key: "legInset", label: "桌腳內縮", defaultValue: 0, min: 0, max: 400, step: 5, help: "桌腳往內移，形成 reveal。0 = 與桌面邊緣齊平" },
  // 桌面 (top)
  { group: "top", type: "number", key: "topThickness", label: "桌面厚", defaultValue: 30, min: 12, max: 60, step: 2 },
  ...
  { group: "top", type: "number", key: "dropLeafWidth", label: "翻板寬", defaultValue: 300, min: 150, max: 500, step: 25, dependsOn: { key: "dropLeaf", notIn: ["none"] } },
  legEdgeOption("leg", 1),
  legEdgeStyleOption("leg"),
  stretcherEdgeOption("stretcher", 1),
  stretcherEdgeStyleOption("stretcher"),
  // 牙條 (apron)
  { group: "apron", type: "number", key: "apronWidth", label: "牙條高", defaultValue: 100, min: 30, max: 200, step: 5 },
  { group: "apron", type: "number", key: "apronThickness", label: "牙條厚", defaultValue: 28, min: 10, max: 50, step: 2 },
  { group: "apron", type: "number", key: "apronOffset", label: "牙條距桌面", defaultValue: 0, min: 0, max: 300, step: 5, help: "牙條頂緣往下退的距離" },
  ...
  { group: "apron", type: "number", key: "centerStretcherWidth", label: "中央牙條高", defaultValue: 50, min: 20, max: 150, step: 5, dependsOn: { key: "withCenterStretcher" } },
  { group: "apron", type: "number", key: "centerStretcherThickness", label: "中央牙條厚", defaultValue: 25, min: 12, max: 50, step: 1, dependsOn: { key: "withCenterStretcher" } },
  { group: "stretcher", type: "number", key: "centerStretcherDrop", label: "中央橫撐距牙條頂", defaultValue: 0, min: 0, max: 200, step: 5, help: "0 = 跟牙條上緣切齊（預設）", dependsOn: { key: "withCenterStretcher" } },
  ...
  { group: "stretcher", type: "number", key: "lowerStretcherWidth", label: "下橫撐高", defaultValue: 50, min: 20, max: 150, step: 5, dependsOn: { all: [{ key: "withLowerStretchers" }, { key: "legShape", notIn: ["trestle"] }] } },
  { group: "stretcher", type: "number", key: "lowerStretcherThickness", label: "下橫撐厚", defaultValue: 28, min: 10, max: 50, step: 1, dependsOn: { all: [{ key: "withLowerStretchers" }, { key: "legShape", notIn: ["trestle"] }] } },
  { group: "stretcher", type: "number", key: "lowerStretcherHeight", label: "下橫撐離地高", defaultValue: 0, min: 0, max: 700, step: 10, help: "設 0 = 自動（腳高的 22%）", dependsOn: { all: [{ key: "withLowerStretchers" }, { key: "legShape", notIn: ["trestle"] }] } },
  { group: "stretcher", type: "number", key: "lowerStretcherDoubleRailGap", label: "雙環下層距上層", defaultValue: 100, min: 50, max: 300, step: 10, help: "雙環模式時，下層 4 條離上層的距離", dependsOn: { all: [{ key: "lowerStretcherArrangement", equals: "double-rail" }, { key: "legShape", notIn: ["trestle"] }] } },
];
