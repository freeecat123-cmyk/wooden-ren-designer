...
export const diningTableOptions: OptionSpec[] = [
  ...
  // 牙條 (apron)
  { group: "apron", type: "number", key: "apronWidth", label: "牙條高 (mm)", defaultValue: 100, min: 30, max: 200, step: 5 },
  { group: "apron", type: "number", key: "apronThickness", label: "牙條厚 (mm)", defaultValue: 28, min: 10, max: 50, step: 2 },
  { group: "apron", type: "number", key: "apronOffset", label: "牙條距桌面 (mm)", defaultValue: 0, min: 0, max: 300, step: 5, help: "牙條頂緣往下退的距離" },
  ...
  { group: "apron", type: "number", key: "centerStretcherWidth", label: "中央牙條高 (mm)", defaultValue: 50, min: 20, max: 150, step: 5, dependsOn: { key: "withCenterStretcher" } },
  { group: "apron", type: "number", key: "centerStretcherThickness", label: "中央牙條厚 (mm)", defaultValue: 25, min: 12, max: 50, step: 1, dependsOn: { key: "withCenterStretcher" } },
  { group: "stretcher", type: "number", key: "centerStretcherDrop", label: "中央橫撐距牙條頂 (mm)", defaultValue: 0, min: 0, max: 200, step: 5, help: "0 = 跟牙條上緣切齊（預設）", dependsOn: { key: "withCenterStretcher" } },
