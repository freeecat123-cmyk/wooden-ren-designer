...
export const teaTableOptions: OptionSpec[] = [
  ...
  { group: "apron", type: "number", key: "upperApronWidth", label: "牙條高 (mm)", defaultValue: 90, min: 30, max: 200, step: 5 },
  { group: "apron", type: "number", key: "upperApronThickness", label: "牙條厚 (mm)", defaultValue: 22, min: 12, max: 50, step: 1 },
  { group: "apron", type: "number", key: "apronOffset", label: "牙條距桌面 (mm)", defaultValue: 0, min: 0, max: 200, step: 5, help: "牙條頂緣往下退離桌面下緣的距離。0 = 貼齊" },
  ...
  { group: "apron", type: "number", key: "apronStaggerMm", label: "牙條錯開 (mm)", defaultValue: 0, min: 0, max: 80, step: 2, unit: "mm", help: "前後牙條（X 軸）相對左右下移量。0 = 等高（自動上下半榫）" },
