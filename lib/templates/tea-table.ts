...
export const teaTableOptions: OptionSpec[] = [
  ...
  { group: "leg", type: "number", key: "legSize", label: "桌腳粗", defaultValue: 50, min: 20, max: 120, step: 2 },
  { group: "leg", type: "number", key: "legInset", label: "桌腳內縮", defaultValue: 0, min: 0, max: 200, step: 5, help: "桌腳往內移，形成 reveal。0 = 與桌面邊緣齊平" },
  ...
  { group: "top", type: "number", key: "dropLeafWidth", label: "翻板寬", defaultValue: 200, min: 150, max: 400, step: 25, dependsOn: { key: "dropLeaf", notIn: ["none"] } },
  ...
  { group: "apron", type: "number", key: "upperApronWidth", label: "牙條高", defaultValue: 90, min: 30, max: 200, step: 5 },
  { group: "apron", type: "number", key: "upperApronThickness", label: "牙條厚", defaultValue: 22, min: 12, max: 50, step: 1 },
  { group: "apron", type: "number", key: "apronOffset", label: "牙條距桌面", defaultValue: 0, min: 0, max: 200, step: 5, help: "牙條頂緣往下退離桌面下緣的距離。0 = 貼齊" },
  ...
  { group: "stretcher", type: "number", key: "lowerStretcherWidth", label: "下橫撐高", defaultValue: 50, min: 20, max: 150, step: 5 },
  { group: "stretcher", type: "number", key: "lowerStretcherThickness", label: "下橫撐厚", defaultValue: 22, min: 12, max: 50, step: 1 },
  { group: "stretcher", type: "number", key: "lowerStretcherHeight", label: "下橫撐離地高", defaultValue: 120, min: 10, max: 400, step: 10, help: "下橫撐底面距地高度" },
