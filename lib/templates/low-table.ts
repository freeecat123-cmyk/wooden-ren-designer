...
export const lowTableOptions: OptionSpec[] = [
  ...
  { group: "apron", type: "number", key: "apronWidth", label: "牙條高 (mm)", defaultValue: 70, min: 30, max: 200, step: 5 },
  ...
  { group: "apron", type: "number", key: "apronOffset", label: "牙條距桌面 (mm)", defaultValue: 0, min: 0, max: 200, step: 5, help: "矮桌體量小，10mm 比例較不會牙條飄離" },
