...
export const lowTableOptions: OptionSpec[] = [
  ...
  { group: "leg", type: "number", key: "legSize", label: "腳粗", defaultValue: 45, min: 20, max: 120, step: 1 },
  { group: "top", type: "number", key: "topThickness", label: "桌面厚", defaultValue: 28, min: 12, max: 60, step: 1 },
  ...
  { group: "apron", type: "number", key: "apronWidth", label: "牙條高", defaultValue: 70, min: 30, max: 200, step: 5 },
  ...
  { group: "apron", type: "number", key: "apronOffset", label: "牙條距桌面", defaultValue: 0, min: 0, max: 200, step: 5, help: "矮桌體量小，10mm 比例較不會牙條飄離" },
  apronEdgeOption("apron", 1),
  apronEdgeStyleOption("apron"),
  { group: "stretcher", type: "number", key: "lowerStretcherHeight", label: "下橫撐離地高", defaultValue: 0, min: 0, max: 400, step: 10, dependsOn: { key: "withLowerStretchers", equals: true } },
];
