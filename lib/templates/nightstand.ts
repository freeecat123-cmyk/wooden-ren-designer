...
export const nightstandOptions: OptionSpec[] = [
  { type: "number", key: "drawerCount", label: "抽屜排數", defaultValue: 1, min: 0, max: 4, step: 1 },
  { type: "number", key: "drawerCols", label: "抽屜列數（左右）", defaultValue: 1, min: 1, max: 3, step: 1 },
  ...
  { type: "select", key: "legShape", label: "腳樣式", defaultValue: "tapered", choices: [
    { value: "box", label: "直腳" },
